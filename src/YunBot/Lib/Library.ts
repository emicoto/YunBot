...
export const CoreLib = {
  ...
  ["灵犀心法"]: {
	...
	maxlevel: 5,
	lvstats: [
	  { ATKbuff: 0.1, Expbuff: 0.2 },
	  { ATKbuff: 0.2, Expbuff: 0.35 },
	  { ATKbuff: 0.3, Expbuff: 0.5 },
	  { ATKbuff: 0.4, Expbuff: 0.65 },
	  { ATKbuff: 0.5, Expbuff: 0.8 },
	],
  },
  ...
  ["灵空心法"]: {
	...
	maxlevel: 5,
	lvstats: [
	  { DEFbuff: 0.1, Expbuff: 0.2 },
	  { DEFbuff: 0.2, Expbuff: 0.35 },
	  { DEFbuff: 0.3, Expbuff: 0.5 },
	  { DEFbuff: 0.4, Expbuff: 0.65 },
	  { DEFbuff: 0.5, Expbuff: 0.8 },
	],
  },
  ...
  ["灵虚心法"]: {
	...
	maxlevel: 5,
	lvstats: [
	  { SPDbuff: 0.1, Expbuff: 0.2 },
	  { SPDbuff: 0.2, Expbuff: 0.35 },
	  { SPDbuff: 0.3, Expbuff: 0.5 },
	  { SPDbuff: 0.4, Expbuff: 0.65 },
	  { SPDbuff: 0.5, Expbuff: 0.8 },
	],
  },
  ...
  ["幻千心法"]: {
	...
	lvstats: [
	  { ATKbuff: 0.10, DEFbuff: 0.10, SPDbuff: 0.10, HPbuff: 0.20, SPbuff: 0.3, Expbuff: 0.50, },
	  { ATKbuff: 0.15, DEFbuff: 0.15, SPDbuff: 0.15, HPbuff: 0.25, SPbuff: 0.4, Expbuff: 0.60, },
	  { ATKbuff: 0.20, DEFbuff: 0.20, SPDbuff: 0.20, HPbuff: 0.30, SPbuff: 0.5, Expbuff: 0.70, },
	  { ATKbuff: 0.25, DEFbuff: 0.25, SPDbuff: 0.25, HPbuff: 0.35, SPbuff: 0.6, Expbuff: 0.80, },
	  { ATKbuff: 0.30, DEFbuff: 0.30, SPDbuff: 0.30, HPbuff: 0.40, SPbuff: 0.7, Expbuff: 0.90, },
	  { ATKbuff: 0.35, DEFbuff: 0.35, SPDbuff: 0.35, HPbuff: 0.45, SPbuff: 0.8, Expbuff: 1.00, },
	  { ATKbuff: 0.40, DEFbuff: 0.40, SPDbuff: 0.40, HPbuff: 0.50, SPbuff: 0.9, Expbuff: 1.10, },
	  { ATKbuff: 0.45, DEFbuff: 0.45, SPDbuff: 0.45, HPbuff: 0.55, SPbuff: 1.0, Expbuff: 1.20, },
	  { ATKbuff: 0.50, DEFbuff: 0.50, SPDbuff: 0.50, HPbuff: 0.60, SPbuff: 1.1, Expbuff: 1.30, },
	  { ATKbuff: 0.55, DEFbuff: 0.55, SPDbuff: 0.55, HPbuff: 0.75, SPbuff: 1.2, Expbuff: 1.40, },
	  { ATKbuff: 0.60, DEFbuff: 0.60, SPDbuff: 0.60, HPbuff: 0.80, SPbuff: 1.3, Expbuff: 1.50, },
	  { ATKbuff: 0.70, DEFbuff: 0.70, SPDbuff: 0.70, HPbuff: 0.85, SPbuff: 1.5, Expbuff: 1.75, },
	],
  },
...
export function CoreDes(core, level?) {
  ...
  let txt = [
	...
	`说明：${core.des}\n`,
	`${ core.lvstats[level]?.HPbuff ? `生命加成：${core.lvstats[level].HPbuff * 100}%　` : "" }`,
	`${ core.lvstats[level]?.SPbuff ? `法力加成：${core.lvstats[level].SPbuff * 100}%　` : "" }`,
	`${ core.lvstats[level]?.ATKbuff ? `攻击加成：${core.lvstats[level].ATKbuff * 100}%　` : "" }`,
	`${ core.lvstats[level]?.DEFbuff ? `防御加成：${core.lvstats[level].DEFbuff * 100}%　` : "" }`,
	`${ core.lvstats[level]?.SPDbuff ? `速度加成：${core.lvstats[level].SPDbuff * 100}%　` : "" }`,
	`${ core.lvstats[level]?.Expbuff ? `经验加成：${core.lvstats[level].Expbuff * 100}%　` : "" }`,
  ];
  return txt.join("");
}
...
export function WeaponDes(weapon) {
  let txt = [
	...
	`${weapon?.SPbuff ? `法力加成：${weapon.SPbuff}　` : ""}`,
